import{e as n}from"./app.eb5e24ec.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const e={},a=n(`<h2 id="nginx-\u914D\u7F6E\u5730\u5740\u8F6C\u53D1\u5230-tomcat" tabindex="-1"><a class="header-anchor" href="#nginx-\u914D\u7F6E\u5730\u5740\u8F6C\u53D1\u5230-tomcat" aria-hidden="true">#</a> nginx \u914D\u7F6E\u5730\u5740\u8F6C\u53D1\u5230 tomcat</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>	try_files $uri $uri/ /index.html; //https://www.cnblogs.com/boundless-sky/p/9459775.html\u4ECB\u7ECD\u8FD9\u4E2A\u5C5E\u6027\u7684
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>\u518D\u6B21\u8BF7\u6C42\uFF1A</p><p>HEAD /index.php HTTP/1.0 HTTP/1.1 200 OK Server: nginx/1.4.6 (Ubuntu) \u5B9E\u9645\u6D4B\u8BD5\uFF0C\u6B63\u5E38\uFF0Cdefault_server \u786E\u5B9E\u8D77\u4F5C\u7528\u4E86\u3002</p><h2 id="ngnix-\u914D\u7F6E\u9879\u8BE6\u89E3" tabindex="-1"><a class="header-anchor" href="#ngnix-\u914D\u7F6E\u9879\u8BE6\u89E3" aria-hidden="true">#</a> ngnix \u914D\u7F6E\u9879\u8BE6\u89E3</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>#\u5B89\u5168\u95EE\u9898\uFF0C\u5EFA\u8BAE\u7528nobody,\u4E0D\u8981\u7528root.
#user  nobody;
