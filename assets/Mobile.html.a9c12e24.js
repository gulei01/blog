import{e as n}from"./app.eb5e24ec.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<blockquote><p>note some js code in mobile</p></blockquote><h2 id="scroll-smooth" tabindex="-1"><a class="header-anchor" href="#scroll-smooth" aria-hidden="true">#</a> scroll smooth</h2><h3 id="code" tabindex="-1"><a class="header-anchor" href="#code" aria-hidden="true">#</a> code</h3><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token comment">// scrollSmooth.js</span>
